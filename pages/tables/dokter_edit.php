...
<head>
    ...
    <title>Edit Data Dokter Binamedika</title>
    <!-- Favicon-->
...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <h2 class="card-inside-title">Edit Data Dokter</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                  <?php 
                                  $kode_dokter = $_GET['kode_dokter'];
                                  $data = mysqli_query($koneksi,"select * from tb_dokter where kode_dokter='$kode_dokter'");
                                  ...
                                  ?>
                                    <form action="dokter_update.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>Kode Dokter</label>
                                                    <input type="hidden" name="kode_dokter" value="<?php echo $d['kode_dokter']; ?>">
                                                    <input type="text" class="form-control" name="kode_dokter" required="required" value="<?php echo $d['kode_dokter']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>Nama Dokter</label>
                                                <input type="text" class="form-control" name="nama_dokter" value="<?php echo $d['nama_dokter'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>No SIP</label>
                                                <input type="text" class="form-control" name="no_sip" value="<?php echo $d['no_sip'] ?>">
                                            </div>
                                        </div>
                                        <div class="footer">
    ...
    <script>
        ...
        request.open('POST', 'dokter_update.php');
