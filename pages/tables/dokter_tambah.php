...
<head>
    ...
    <title>Tambah Dokter Binamedika</title>
    <!-- Favicon-->
...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <h2 class="card-inside-title">Tambah Data Baru Dokter</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <form action="dokter_act.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" name="nama_dokter" placeholder="Masukan Nama Lengkap">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>No Handphone</label>
                                                 <input type="text" class="form-control" name="no_hp" placeholder="Masukan Nomer Handphone">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>No SIP</label>
                                                <input type="text" class="form-control" name="no_sip"placeholder="Masukan Nomer SIP" >
                                            </div>
                                        </div>
                                        <div class="footer">
                                            <a href="datadokter.php" type="button" class="btn bg-grey waves-effect">Kembali</a>
    ...
    document.getElementById('submitBtn').addEventListener('click', function(event) {
        ...
        var kodeDokterInput = form.querySelector('input[name="kode_dokter"]');
        var kodeDokterValue = kodeDokterInput.value;
        ...
        // if (form.checkValidity()) {
            ...
            request.onload = function() {
                if (request.status === 200) {
                    if (request.responseText === 'duplicate') {
                        ...
                        showNotification('Kode dokter telah tersedia.', 'danger');
            ...
            request.open('POST', 'dokter_act.php');
            request.send(new URLSearchParams('kode_dokter=' + kodeDokterValue));
        } else {
            // Form is not valid, show notification to fill in required fields
            showNotification('Mohon lengkapi semua field yang harus diisi.', 'warning');
        // }
    });
