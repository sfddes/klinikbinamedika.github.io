...
<head>
    ...
    <title>Riwayat Edit Binamedika</title>
    <!-- Favicon-->
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">WELCOME binamedika !</div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <h2 class="card-inside-title">Edit Data Riwayat Pengobatan Pasien</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                  <?php 
                                  $id_riwayat = $_GET['id_riwayat'];
                                  $data = mysqli_query($koneksi,"select * from tb_riwayats where id_riwayat='$id_riwayat'");
                                  while($d = mysqli_fetch_array($data)){
                                  ?>
                                    <form action="riwayat_update.php" method="post" enctype="multipart/form-data" onsubmit="return validateDate();">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>ID Pasien</label>
                                                    <input type="hidden" name="id_riwayat" value="<?php echo $d['id_riwayat']; ?>">
                                                    <input type="text" class="form-control" name="kode_pasien" required="required" value="<?php echo $d['kode_pasien']?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label> Jenis Pasien</label>
                                                <select type="text"class="form-control" name="jenis_pasien" value="<?php echo $d['jenis_pasien'] ?> ">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select type="text"class="form-control" required="required" name="kode_dokter" value="<?php echo $d['kode_dokter'] ?> ">
                                                <option disable selected></option>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>Diagnosa Pasien</label>
                                                 <input type="text" class="form-control" name="diagnosa" value="<?php echo $d['diagnosa'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>Kode Obat</label>
                                                <select class="form-control" name="kode_obat[]" multiple required="required" value="<?php echo $d['kode_obat'] ?>">
                                                <option disable selected></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="jmlh_obat[]" value="<?php echo $d['jmlh_obat'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>Aturan Pakai</label>
                                                <select type="text"class="form-control" name="aturan_pakai" value="<?php echo $d['aturan_pakai'] ?> ">
                                                <option disable selected></option>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control" name="tgl_periksa" value="<?php echo $d['tgl_periksa'] ?>" max="<?php echo date('Y-m-d'); ?>"oninput="validateForm()">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" name="tot_harga_jual" value="<?php echo $d['tot_harga_jual'] ?>">
                                            </div>
                                        </div>
                                        <div class="footer">
...
document.getElementById('submitBtn').addEventListener('click', function(event) {
    ...
    if (!validateRequiredFields(formData)) {
        showNotification('Mohon lengkapi semua bagian yang wajib diisi.', 'danger');
        return;
    }
    ...
    request.onload = function() {
        if (request.status === 200) {
            if (request.responseText === 'duplicate') {
                showNotification('Kode Pasien sudah ada dalam riwayat pengobatan lain. Tidak bisa diubah.', 'danger');
                setTimeout(function() {
                ...
                showNotification('Terjadi kesalahan saat memperbarui data.', 'warning');
                setTimeout(function() {
                    window.location.href = 'riwayatobat.php';
                }, 3000);
            }
    ...
    request.open('POST', 'riwayat_update.php');
    request.send(formData);
});

function validateRequiredFields(formData) {
    var kodePasienInput = formData.get('kode_pasien');
    var kodeDokterInput = formData.get('kode_dokter');
    var kodeObatInput = formData.getAll('kode_obat[]');
    var jmlhObatInput = formData.getAll('jmlh_obat[]');

    if (kodePasienInput === '' || kodeDokterInput === '' ||
        kodeObatInput.length === 0 || jmlhObatInput.length === 0) {
        return false;
    }
