...
<body class="theme-red">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <h2 class="card-inside-title">Tambah Data Baru Pasien</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <form action="pasien_act.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>No.Kartu Kesehatan</label>
                                                <input type="text" class="form-control" name="no_kartu" placeholder="Masukan Nomer Kartu Kesehatan" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>Jenis Pasien</label>
                                                    <select class="form-control" name="jenis_pasien">
                                                      ...
                                                      <!-- <option value="Binamedika">BinaMedika</option> -->
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>Umur</label>
                                                 <input type="text" class="form-control" name="umur" placeholder="Masukan Umur Pasien">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                        ...
                                        <div class="footer">
                                            <a href="datapasien.php" type="button" class="btn bg-grey waves-effect">Kembali</a>
    ...
    <script>
        document.getElementById('submitBtn').addEventListener('click', function(event) {
            ...
            request.onload = function() {
                if (request.status === 200) {
                    if (request.responseText === 'duplicate') {
                        ...
                        showNotification('Kode pasien telah tersedia.', 'danger');
            ...
            request.open('POST', 'pasien_act.php');
            request.send(new URLSearchParams('kode_pasien=' + kodePasienValue));
