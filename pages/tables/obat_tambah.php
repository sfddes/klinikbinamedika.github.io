...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <h2 class="card-inside-title">Tambah Data Baru Obat</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <form action="obat_act.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label for="kode_obat">Kode Obat</label>
                                                <input type="text" class="form-control" name="kode_obat" id="kode_obat" placeholder="Masukan kode obat" required >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Tempat Penyimpanan</label>
                                                ...
                                                <option disable selected></option>
                                                <option value="Etalase 1">ETALASE 1</option>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" name="harga_beli" placeholder="Masukan harga beli obat">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>Harga Jual</label>
                                                <input type="text" class="form-control" name="harga_jual" placeholder="Masukan harga jual obat">
                                            </div>
                                        </div>                                        
                                        <div class="form-group">
                                            <div class="form-line">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control" name="min_stock" placeholder="Masukan sisa obat">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label>Stock</label>
                                                <input type="text" class="form-control" name="stock" placeholder="Masukan stok obat">
                                            </div>
                                        </div>                                        
                                        <div class="form-group">
                                            <a href="dataobat.php" type="button" class="btn bg-grey waves-effect">Kembali</a>
                                            <button class="btn bg-red waves-effect" type="submit">Simpan</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    <script>
        document.getElementById('submitBtn').addEventListener('click', function(event) {
            ...
            var kodeObatInput = form.querySelector('input[name="kode_obat"]');
            var kodeObatValue = kodeObatInput.value;
            ...
            request.onload = function() {
                if (request.status === 200) {
                    if (request.responseText === 'duplicate') {
                        ...
                        showNotification('Kode obat telah tersedia.', 'danger');
            ...
            request.open('POST', 'obat_act.php');
            request.send(new URLSearchParams('kode_obat=' + kodeObatValue));
        });
