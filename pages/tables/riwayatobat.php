...
<body class="theme-red">
        ...
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    ...
                    <small>Diambil dari <a href="riwayatobat.php" target="_blank">data tabel pengobatan pasien</a></small>
                </h2>
            </div>
            <!-- Basic Examples -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <a href="riwayat_tambah.php" class="btn btn-info btn-sm pull" style="background-color:#00FFF; border-color:gray; color:white"><i class="material-icons">note_add</i> &nbsp Tambah Data Baru</a>              
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                       <?php
                                        include '../../koneksi.php';
                                        $no=1;
                                        $data = mysqli_query($koneksi,"SELECT * FROM tb_riwayats ORDER BY id_riwayat DESC");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    echo implode(", ", $obat_info);
                                                    ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    // Mengambil informasi jumlah obat dari detail_riwayat berdasarkan id_riwayat
                                                    $jmlh_obat_query = mysqli_query($koneksi, "SELECT jmlh_obat FROM detail_riwayat WHERE id_riwayat = '{$d['id_riwayat']}'");
                                                    $jmlh_obat_info = [];
                                                
                                                    while ($obat = mysqli_fetch_array($jmlh_obat_query)) {
                                                        $jmlh_obat_info[] = $obat['jmlh_obat'];
                                                    }
                                                
                                                    // Menampilkan informasi jumlah obat dari detail_riwayat dalam satu baris pada kolom "jmlh_obat"
                                                    echo implode(", ", $jmlh_obat_info);
                                                    ?>
                                                </td>
                                                <td><?php echo $d['aturan_pakai'] ?></td>
                                                <td><?php echo $d['tgl_periksa']; ?></td>
                                                <td><?php echo 'Rp ' . number_format($d['tot_harga_jual'], 0, ',', '.'); ?></td>
                                                <td>
                                                    <button type="button" class="btn bg-deep-orange waves-effect" onclick="location.href='riwayat_edit.php?id_riwayat=<?php echo $d['id_riwayat']; ?>'">
                                                        <i class="material-icons">edit</i>
                                                    </button>
                                                    <button type="button" class="btn bg-grey waves-effect" onclick="showRiwayat('<?php echo $d['id_riwayat']; ?>')">
    ...
    <script>
    function showRiwayat(idRiwayat) {
        // Mengalihkan ke halaman riwayat_lihat.php dengan mengirimkan ID riwayat
        location.href = 'riwayat_lihat.php?id_riwayat=' + idRiwayat;
    }
